...
Chisel is a Project that was assigned this last week. The overall goal is to try taking a set of problems, break them down, plan a solution and use Test Driven Development to build a solution. The most challening parts for me were:

* TDD: I found it challenging to write and understand what I wanted each test to do. It was quite different to try and imagine a method that does not exist yet. I would like to learn better test statements.
* Understanding how each class relies on the previous class.
* Knowing where to start. The hardest part was choosing a single part /problem to start with.
...
Here is a list of items and points of weakness provided during the Chisel Assessment.

 https://github.com/turingschool/ruby-submissions/blob/master/1507/03-chisel.markdown
